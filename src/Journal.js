            ...
            <main>
                ...
                <section className="journal-intro">
                    ...
                    <article className="journal-inspiration">
                        <img src={require("./images/applyimg.png")} alt="journal"/>
                        <div>
                            <h6>INSPIRATION</h6>
                            <h2>
                            ...
                            <div id="journal-author">
                                <img src={require("./images/ezra.png")} alt="journal"/>
                ...
                <section className="journal-cards">
                    <div className="journal-cards-container">
                        <article>
                            <img src={require("./images/journal1.png")} alt="journal" />
                            <h6>INSPIRATION</h6>
                            <h2>
                                Learn Design Thinking
                                like a Pro and Build
                        ...
                        <article>
                            <img src={require("./images/journal2.png")} alt="journal" />
                            <h6>INSPIRATION</h6>
                            <h2>
                                Learn Design Thinking
                                like a Pro and Build
                        ...
                        <article>
                            <img src={require("./images/journal3.png")} alt="journal" />
                            <h6>INSPIRATION</h6>
                            <h2>
                                Learn Design Thinking
                                like a Pro and Build
                        ...
                        <article>
                            <img src={require("./images/journal4.png")} alt="journal" />
                            <h6>INSPIRATION</h6>
                            <h2>
                                Learn Design Thinking
                                like a Pro and Build
